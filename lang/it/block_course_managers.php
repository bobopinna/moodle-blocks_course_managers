<?php
   ...
   $string['timetable'] = 'Orario delle Lezioni';
   $string['timetableurl_config'] = 'URL orari delle lezioni online';
   $string['timetableurl_config_desc'] = 'Impostare qui l\'url per la pagina degli orari dei docenti. La pagina web deve contenere la lista dei docenti con i link agli orari.';
